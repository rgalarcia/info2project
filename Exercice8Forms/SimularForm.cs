...
namespace Exercice8Forms
{
    public partial class SimularForm : Form
    {
        ...
        private void SimularForm_Load(object sender, EventArgs e)
        {
            ...
            vuelo1.Location = new Point(Convert.ToInt32(miPlan1.GetIX()),Convert.ToInt32(miPlan1.GetIY())); 
            ...
            vuelo2.Location = new Point(Convert.ToInt32(miPlan2.GetIX()), Convert.ToInt32(miPlan2.GetIY()));
            ...
            destino1.Location = new Point(Convert.ToInt32(miPlan1.GetFX()), Convert.ToInt32(miPlan1.GetFY())); 

            PictureBox destino2 = new PictureBox();
            destino2.Size = new Size(8, 8);
            destino2.BackColor = Color.Red;
            destino2.Location = new Point(Convert.ToInt32(miPlan2.GetFX()), Convert.ToInt32(miPlan2.GetFY()));

            PictureBox origen1 = new PictureBox();
            origen1.Size = new Size(8, 8);
            origen1.BackColor = Color.Red;
            origen1.Location = new Point(Convert.ToInt32(miPlan1.GetIX()),Convert.ToInt32(miPlan1.GetIY()));

            PictureBox origen2 = new PictureBox();
            origen2.Size = new Size(8, 8);
            origen2.BackColor = Color.Red;
            origen2.Location = new Point(Convert.ToInt32(miPlan2.GetIX()), Convert.ToInt32(miPlan2.GetIY()));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    Reloj.Interval = Convert.ToInt32(tiempoBox.Text)*1000;
                    Reloj.Start();
